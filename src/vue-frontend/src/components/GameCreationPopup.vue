...
<template>
  <div
    class="game-creation-popup-overlay"
    :class="{ active: isActive }"
    @click.self="closePopup"
  >
    <div class="game-creation-popup-content">
      <button
        class="game-creation-popup-close"
        aria-label="Close"
        @click="closePopup"
      >
        &times;
      ...
      <div class="game-creation-popup-header">
        <h2 class="game-creation-popup-title">
          {{ t("game_creation.title") }}
        </h2>
      </div>
      ...
      <div class="game-creation-popup-body">
        <div class="popup-form-group form-group">
          ...
          <select
            id="popupInputSport"
            class="popup-select form-control"
        ...
        <div class="popup-form-group form-group">
          ...
          <textarea
            class="popup-textarea form-control"
            id="popupInputNote"
            rows="3"
            v-model="form.note"
          ></textarea>
        ...
        <div
          class="popup-actions"
          style="justify-content: center; margin-top: 1.5rem; display: flex"
        >
          <button
            type="button"
