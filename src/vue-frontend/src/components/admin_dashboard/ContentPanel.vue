      ...
      <div class="card compact-card h-100">
        ...
        <div class="card-body">
          <form @submit.prevent="addPlace">
            ...
            <button
              type="submit"
              class="btn btn-primary-custom btn-sm w-100 fw-bold mt-2"
            >
      ...
      <div class="card compact-card h-100">
        ...
        <div class="card-body d-flex flex-column">
          ...
          <div class="d-flex flex-column flex-grow-1" style="min-height: 0">
            <h3 class="h6 text-secondary small mb-2">
            ...
            <div class="list-group-scrollable flex-grow-1">
              <ul class="list-group list-group-flush">
                <li
                  v-if="loading"
                  class="list-group-item text-center text-secondary py-1 small"
                >
                  {{ t("common.loading") }}
                </li>
                <li
                  v-for="sport in sports"
                  :key="sport._id"
                  class="list-group-item py-1 small"
                >
                  {{ sport.name }}
                </li>
              </ul>
